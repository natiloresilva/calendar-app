...
describe('Pruebas en las acciones Auth', () => {
    ...
    test('startLogin correcto', async () => {
        ...
        await store.dispatch(startLogin('kevin@gmail.com', '123467'))
    ...
    test('startLogin incorrecto', async () => {
        ...
        await store.dispatch(startLogin('kevin@gmail.com', '12346789'))
        let actions = store.getActions()

        expect(actions).toEqual([])
        expect(Swal.fire).toHaveBeenCalledWith('Error', 'Invalid Password', 'error')

        await store.dispatch(startLogin('kevin@gmail2.com', '1234567'))
        actions = store.getActions()

        expect(Swal.fire).toHaveBeenCalledWith('Error', 'No user found with this email', 'error')
